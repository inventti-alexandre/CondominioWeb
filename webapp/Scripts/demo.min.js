$("#main").append('<div class="demo"><span id="demo-setting"><i class="fa fa-cogs fa-spin txt-color-blueDark"></i></span></div>');
...
$("#smart-bgimages").fadeOut(), $('input[type="checkbox"]#smart-fixed-header').click(function () {
