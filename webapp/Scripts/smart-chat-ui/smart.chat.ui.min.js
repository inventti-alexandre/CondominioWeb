    ...
    a.widget("ui.chatbox", {
        ...
        "_create": function () {
            var b = this,
                ...
                k = (b.uiChatboxInputBox = a("<textarea id='ta_" + b.options.id + "' class='textarea_chat'></textarea>")).addClass("ui-widget-content ui-chatbox-input-box ").appendTo(j).keydown(function (c) {
                    //return c.keyCode && c.keyCode == a.ui.keyCode.ENTER ? (msg = a.trim(a(this).val()), msg.length > 0 && b.options.messageSent(b.options.id, b.options.user, msg), a(this).val(""), !1, ShowMessage(b.options.id, b.options.user, msg)) : void 0
                    return c.keyCode && c.keyCode == a.ui.keyCode.ENTER ? (msg = a.trim(a(this).val()), msg.length > 0, a(this).val(""), !1, ShowMessage(b.options.id, b.options.user, msg)) : void 0
                }).focusin(function () {
